...
/**
 * Generates sitemap.xml content from static pages, posts, and docs.
 *
 * The controller only handles the HTTP response — this class owns
 * all the XML building logic so it can be tested or reused (e.g.
 * from a CLI command or cache warm-up) without an HTTP context.
 */
final readonly class SitemapGenerator
{
	 ...
	 *
	 * @return string Valid XML ready to be served as application/xml
	 */
	...
	/**
	 * Builds a single <url> entry for the sitemap.
	 */
